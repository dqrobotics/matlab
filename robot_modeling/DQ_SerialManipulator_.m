...
classdef (Abstract) DQ_SerialManipulator_ < DQ_Kinematics
    ...
    methods
        function obj = DQ_SerialManipulator_(dim_configuration_space)
            if nargin == 0
        ...
        function n_links = get_dim_configuration_space(obj)
         % GET_DIM_CONFIGURATION_SPACE()
         n_links = obj.dim_configuration_space_;
